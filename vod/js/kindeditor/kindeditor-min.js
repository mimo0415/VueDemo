...
(function(A, o) {
    function Y(a) { if (!a) return !1; return Object.prototype.toString.call(a) === "[object Array]" }

    function bb(a) { if (!a) return !1; return Object.prototype.toString.call(a) === "[object Function]" }
    ...
    function ua(a, b, c) { c = c === o ? "," : c; return (c + b + c).indexOf(c + a + c) >= 0 }
    ...
    function va(a) {
        function b(a) { a = parseInt(a, 10).toString(16).toUpperCase(); return a.length > 1 ? a : "0" + a }
        return a.replace(/rgb\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/ig, function(a, d, e, g) { return "#" + b(d) + b(e) + b(g) })
    }
    ...
    function Fa(a, b) { return Array.prototype.slice.call(a, b || 0) }

    function j(a, b) { return a === o ? b : a }
    ...
    function Pb(a, b, c) { a.addEventListener ? a.addEventListener(b, c, db) : a.attachEvent && a.attachEvent("on" + b, c) }

    function wa(a, b, c) { a.removeEventListener ? a.removeEventListener(b, c, db) : a.detachEvent && a.detachEvent("on" + b, c) }

    function eb(a, b) { this.init(a, b) }
    ...
    function $(a, b, c) {
        if (b.indexOf(",") >= 0) m(b.split(","), function() { $(a, this, c) });
        else {
            var d = a[Z] || null;
            d || (a[Z] = ++gb, d = gb);
            v[d] === o && (v[d] = {});
    ...
    function ha(a, b, c) {
        if (b && b.indexOf(",") >= 0) m(b.split(","), function() { ha(a, this, c) });
            ...
            if (d)
                if (b === o) d in v && (m(v[d],
                    function(b, c) { b != "el" && c.length > 0 && wa(a, b, c[0]) }), delete v[d], fb(a));
                else if (v[d]) {
                var e = v[d][b];
                if (e && e.length > 0) {
                    c === o ? (wa(a, b, e[0]), delete v[d][b]) : (m(e, function(a, b) { a > 0 && b === c && e.splice(a, 1) }), e.length == 1 && (wa(a, b, e[0]), delete v[d][b]));
                    var g = 0;
                    m(v[d], function() { g++ });
                    g < 2 && (delete v[d], fb(a))
                }
    ...
    function hb(a, b) {
        if (b.indexOf(",") >= 0) m(b.split(","), function() { hb(a, this) });
        else { var c = a[Z] || null; if (c) { var d = v[c][b]; if (v[c] && d && d.length > 0) d[0]() } }
    }
            ...
            a = a.replace(/([ \t\n\r]*)<(\/)?([\w\-:]+)((?:\s+|(?:\s+[\w\-:]+)|(?:\s+[\w\-:]+=[^\s"'<>]+)|(?:\s+[\w\-:"]+="[^"]*")|(?:\s+[\w\-:"]+='[^']*'))*)(\/)?>([ \t\n\r]*)/g, function(a,
                ...
                if (J !== "") {
                    ...
                    if (l === "font") {
                        ...
                        F && !/;$/.test(F) && (F += ";");
                        m(K, function(a, b) { b !== "" && (/\s/.test(b) && (b = "'" + b + "'"), F += a + ":" + b + ";") });
                        w.style = F
                    }
                    m(w, function(a, d) {
                        Sb[a] && (w[a] = a);
                    ...
                    J = "";
                    m(w, function(a, b) { a === "style" && b === "" || (b = b.replace(/"/g, "&quot;"), J += " " + a + '="' + b + '"') })
                }
                l === "font" && (l = "span");
                return n + "<" + r + l + J + p + ">" + j
            }),
    ...
    function lb(a, b) {
        a = a.replace(/<meta[\s\S]*?>/ig, "").replace(/<![\s\S]*?>/ig,
            "").replace(/<style[^>]*>[\s\S]*?<\/style>/ig, "").replace(/<script[^>]*>[\s\S]*?<\/script>/ig, "").replace(/<w:[^>]+>[\s\S]*?<\/w:[^>]+>/ig, "").replace(/<o:[^>]+>[\s\S]*?<\/o:[^>]+>/ig, "").replace(/<xml>[\s\S]*?<\/xml>/ig, "").replace(/<(?:table|td)[^>]*>/ig, function(a) { return a.replace(/border-bottom:([#\w\s]+)/ig, "border:$1") });
        return S(a, b)
    }
    ...
    function nb(a) { return H(unescape(a)) }
    ...
    function ya(a, b) {
        ...
        if (!Tb && a.nodeName.toLowerCase() != "script") {
            ...
            d = H(fa(d.innerHTML));
            b in d && (c = d[b])
        } else try { c = a.getAttribute(b, 2) } catch (e) { c = a.getAttribute(b, 1) }
        b === "style" && c !== null && (c = Rb(c));
        return c
    }

    function za(a, b) {
        function c(a) { if (typeof a != "string") return a; return a.replace(/([^\w\-])/g, "\\$1") }
        ...
        function h(a, b, d, e) { for (var g = [], d = e.getElementsByTagName(d), h = 0, f = d.length; h < f; h++) e = d[h], e.nodeType == 1 && (b === null ? ya(e, a) !== null && g.push(e) : b === c(ya(e, a)) && g.push(e)); return g }
        ...
        if (k.length > 1) {
            var n = [];
            m(k, function() { m(za(this, b), function() { N(this, n) < 0 && n.push(this) }) });
            return n
        }
    ...
    function T(a) { if (!a) return document; return a.ownerDocument || a.document || a }
    ...
    function Ub(a, b) {
        if (a.nodeType == 1) {
            ...
            } catch (e) { f(a).empty(), f("@" + b, c).each(function() { a.appendChild(this) }) }
        }
    }
    ...
    function Ka(a) { if (!a || !a.nodeName) return ""; return a.nodeName.toLowerCase() }
    ...
    function G(a) { a = a || document; return O ? a.body : a.documentElement }
    ...
    function pb(a) { a.collapsed = a.startContainer === a.endContainer && a.startOffset === a.endOffset; return a }
            ...
            for (var j = e.firstChild, o; j;) {
                ...
                if (n > 0)
                    if (j.nodeType == 1)
                        ...
                        j == k.endContainer ? d(j, 0, k.endOffset) : d(j, 0, j.nodeValue.length), b)) try { l.appendChild(j) } catch (s) {}
                j = o
            }
        }
        var h = a.doc,
    ...
    function Na(a) { if (!a.nodeName) return a.constructor === L ? a : sb(a); return new L(a) }

    function P(a, b, c) { try { a.execCommand(b, !1, c) } catch (d) {} }

    function tb(a, b) {
        var c = "";
        try { c = a.queryCommandValue(b) } catch (d) {}
        typeof c !== "string" && (c = "");
        return c
    }

    function Oa(a) { var b = U(a); return a.selection || b.getSelection() }
    ...
    function Pa(a, b) { return vb(a, b, "*") || vb(a, b) }
    ...
    function Qa(a, b) { a.type == 1 && (wb(a, b, "*"), wb(a, b)) }
    ...
    function Ra(a) { for (; a.first();) a = a.first(); return a }

    function da(a) { if (a.type != 1 || a.isSingle()) return !1; return a.html().replace(/<[^>]+>/g, "") === "" }

    function Wb(a, b, c) {
        m(b, function(b, c) { b !== "style" && a.attr(b, c) });
        m(c, function(b, c) { a.css(b, c) })
    }

    function na(a) { this.init(a) }

    function xb(a) { a.nodeName && (a = T(a), a = Na(a).selectNodeContents(a.body).collapse(!1)); return new na(a) }
    ...
    function R(a) { this.init(a) }

    function Ua(a) { return new R(a) }

    function Ta(a) { a = f(a)[0]; return a.contentDocument || a.contentWindow.document }
    ...
    function oa(a, b) { if (a.hasVal()) { if (b === o) { var c = a.val(); return c = c.replace(/(<(?:p|p\s[^>]*)>) *(<\/p>)/ig, "") } return a.val(b) } return a.html(b) }

    function pa(a) { this.init(a) }

    function yb(a) { return new pa(a) }
    ...
    function Ab(a) { return new Aa(a) }

    function qa(a) { this.init(a) }

    function Wa(a) { return new qa(a) }

    function ra(a) { this.init(a) }

    function Bb(a) { return new ra(a) }

    function Xa(a) { this.init(a) }

    function sa(a) { this.init(a) }

    function Cb(a) { return new sa(a) }
    ...
    function Db(a) { var b = a.indexOf("?"); return b > 0 ? a.substr(0, b) : a }
    ...
    function Fb(a) { var b, c = "core"; if (b = /^(\w+)\.(\w+)$/.exec(a)) c = b[1], a = b[2]; return { ns: c, key: a } }
                ...
                if (a._contextmenus.length !== 0) {
                    ...
                    if (d.length > 0) {
                        ...
                        var g = f(a.edit.iframe).pos(),
                            h = Wa({ x: g.x + b.clientX, y: g.y + b.clientY, width: c, css: { visibility: "hidden" }, shadowMode: a.shadowMode });
                        m(d, function() {
                            this.title &&
                                h.addItem(this)
                        });
    ...
    function X(a) { return B(a.replace(/<span [^>]*id="?__kindeditor_bookmark_\w+_\d+__"?[^>]*><\/span>/ig, "")) }

    function $a(a) { return a.replace(/<div[^>]+class="?__kindeditor_paste__"?[^>]*>[\s\S]*?<\/div>/ig, "") }
    ...
    function Jb(a, b) {
        function c(a) { m(V, function(b, c) { c.call(a, KindEditor) }); return a.create() }
        b = b || {};
        ...
        if ((d = f(a)) && d.length !==
            0) {
            if (d.length > 1) return d.each(function() { Jb(this, b) }), _instances[0];
            b.srcElement = d[0];
            var e = new ta(b);
            _instances.push(e);
    ...
    function Kb(a, b) { f(a).each(function(a, d) { f.each(_instances, function(a, c) { if (c && c.srcElement[0] == d) return b.call(c, a, c), !1 }) }) }
    if (!A.KindEditor) {
        ...
        var db = !1,
            ...
            q = u("33..40"),
            ab = {};
        m(Nb, function(a, b) { ab[a] = b });
        m(q, function(a, b) { ab[a] = b });
        ...
        var Z = "kindeditor_" + Ca,
            gb = 0,
            v = {};
        l && A.attachEvent("onunload", function() { m(v, function(a, b) { b.el && ha(b.el) }) });
        f.ctrl = Ga;
        f.ready = function(a) {
            function b() { e || (e = !0, a(KindEditor)) }

            function c() {
                if (!e) {
                    try { document.documentElement.doScroll("left") } catch (a) { setTimeout(c, 100); return }
                    b()
                }
            }

            function d() { document.readyState === "complete" && b() }
            var e = !1;
            if (document.addEventListener) $(document, "DOMContentLoaded", b);
            else if (document.attachEvent) {
                $(document, "readystatechange", d);
                var g = !1;
                try { g = A.frameElement == null } catch (f) {}
        ...
        f.query = function(a, b) { var c = za(a, b); return c.length > 0 ? c[0] : null };
        f.queryAll = za;
        E(D, {
            init: function(a) {
            ...
            bind: function(a, b) { this.each(function() { $(this, a, b) }); return this },
            ...
            attr: function(a, b) {
                ...
                if (typeof a === "object") return m(a, function(a, b) { c.attr(a, b) }), c;
                if (b === o) return b = c.length < 1 ? null : ya(c[0], a), b === null ? "" : b;
                c.each(function() { Ja(this, a, b) });
                return c
            },
            ...
            hasClass: function(a) { if (this.length < 1) return !1; return ua(a, this[0].className, " ") },
            addClass: function(a) { this.each(function() { if (!ua(a, this.className, " ")) this.className = B(this.className + " " + a) }); return this },
            removeClass: function(a) { this.each(function() { if (ua(a, this.className, " ")) this.className = B(this.className.replace(RegExp("(^|\\s)" + a + "(\\s|$)"), " ")) }); return this },
            html: function(a) {
                if (a === o) { if (this.length < 1 || this.type != 1) return ""; return S(this[0].innerHTML) }
                this.each(function() {
                    Ub(this,
                        a)
                });
            ...
            text: function() { if (this.length < 1) return ""; return l ? this[0].innerText : this[0].textContent },
            hasVal: function() { if (this.length < 1) return !1; return !!Mb[Ka(this[0])] },
            val: function(a) { if (a === o) { if (this.length < 1) return ""; return this.hasVal() ? this[0].value : this.attr("value") } else return this.each(function() { Mb[Ka(this)] ? this.value = a : Ja(this, "value", a) }), this },
            css: function(a, b) {
                var c = this;
                if (a === o) return aa(c.attr("style"));
                if (typeof a === "object") return m(a, function(a, b) { c.css(a, b) }), c;
                if (b ===
                    o) { if (c.length < 1) return ""; return c[0].style[ga(a)] || Vb(c[0], a) || "" }
                c.each(function() { this.style[ga(a)] = b });
                return c
            },
            width: function(a) { if (a === o) { if (this.length < 1) return 0; return this[0].offsetWidth } return this.css("width", s(a)) },
            height: function(a) { if (a === o) { if (this.length < 1) return 0; return this[0].offsetHeight } return this.css("height", s(a)) },
            opacity: function(a) { this.each(function() { this.style.opacity === o ? this.style.filter = a == 1 ? "" : "alpha(opacity=" + a * 100 + ")" : this.style.opacity = a == 1 ? "" : a }); return this },
            data: function(a, b) {
                a = "kindeditor_data_" + a;
                if (b === o) { if (this.length < 1) return null; return this[0][a] }
                this.each(function() { this[a] = b });
                return this
            },
            pos: function() {
                var a = this[0],
            ...
            isSingle: function() { return !!ib[this.name] },
            isInline: function() { return !!jb[this.name] },
            isBlock: function() { return !!kb[this.name] },
            isStyle: function() { return !!Lb[this.name] },
            isControl: function() { return !!dc[this.name] },
            contains: function(a) {
                if (this.length <
                    1) return !1;
        ...
        E(L, {
            ...
            cloneContents: function() { return Ma(this, !0, !1) },
            deleteContents: function() { return Ma(this, !1, !0) },
            extractContents: function() { return Ma(this, !0, !0) },
            ...
            get: function(a) {
                var b = this.doc;
                if (!l) { b = b.createRange(); try { b.setStart(this.startContainer, this.startOffset), b.setEnd(this.endContainer, this.endOffset) } catch (c) {} return b }
            ...
            up: function() {
                function a(a, d, e) { a.nodeType == 3 && (d === 0 ? e ? b.setStartBefore(a) : b.setEndBefore(a) : d == a.nodeValue.length && (e ? b.setStartAfter(a) : b.setEndAfter(a))) }
                var b = this;
                a(b.startContainer, b.startOffset, !0);
                a(b.endContainer, b.endOffset, !1);
                return b
        ...
        E(na, {
            ...
            selection: function(a) {
                ...
                c = Oa(b);
                var d;
                try { d = c.rangeCount > 0 ? c.getRangeAt(0) : c.createRange() } catch (e) {}
            ...
            select: function(a) {
                ...
                if (a && d.nodeType == 1 && c.collapsed) {
                    if (l) {
                        ...
                        try { i.moveToElementText(b[0]) } catch (n) {}
                        i.collapse(!1);
                        i.select();
                        b.remove();
                        h.focus();
                ...
                if (l) try { i = c.get(!0), i.select() } catch (r) {} else k && c.collapse(!1), i = c.get(!0), b.removeAllRanges(), b.addRange(i), g !== document && (c = f(i.endContainer).pos(), h.scrollTo(c.x, c.y));
                h.focus();
                return this
            },
            wrap: function(a) {
                    ...
                    if (!g && a == e.start) g = !0;
                        ...
                        a: {
                            for (d = b; d && d.name != "body";) {
                                if (Ha[d.name] || d.name == "div" && d.hasClass("ke-script")) { d = !0; break a }
                                d = d.parent()
                            }
                            d = !1
                        }
            ...
            split: function(a, b) {
                for (var c = this.range, d = c.doc, e = c.cloneRange().collapse(a), g = e.startContainer, h = e.startOffset, i = g.nodeType == 3 ? g.parentNode : g, k = !1, n; i && i.parentNode;) {
                    n = f(i);
                    if (b) { if (!n.isStyle()) break; if (!Pa(n, b)) break } else if (Ea[n.name]) break;
                    k = !0;
                    i = i.parentNode
                }
            ...
            state: function(a) {
                var b = this.doc,
                    c = !1;
                try { c = b.queryCommandState(a) } catch (d) {}
                return c
            },
            val: function(a) {
                var b =
            ...
            forecolor: function(a) { return this.toggle('<span style="color:' + a + ';"></span>', { span: ".color=" + a, font: "color" }) },
            hilitecolor: function(a) { return this.toggle('<span style="background-color:' + a + ';"></span>', { span: ".background-color=" + a }) },
            fontsize: function(a) { return this.toggle('<span style="font-size:' + a + ';"></span>', { span: ".font-size=" + a, font: "size" }) },
            fontname: function(a) { return this.fontfamily(a) },
            fontfamily: function(a) { return this.toggle('<span style="font-family:' + a + ';"></span>', { span: ".font-family=" + a, font: "face" }) },
            ...
            inserthtml: function(a, b) {
                ...
                var e = this,
                    g = e.range;
                if (a === "") return e;
                if (l && b) { try { c(g, a) } catch (h) { d(g, a) } return e }
                d(g, a);
                return e
            },
        ...
        E(R, {
            ...
            pos: function(a, b, c) { c = j(c, !0); if (a !== null && (a = a < 0 ? 0 : s(a), this.div.css("left", a), c)) this.x = a; if (b !== null && (b = b < 0 ? 0 : s(b), this.div.css("top", b), c)) this.y = b; return this },
        ...
        E(pa, R, {
            init: function(a) {
                function b() {
                    ...
                    W && f(b).click(function(a) { f(a.target).name === "img" && (k.selection(!0), k.range.selectNode(a.target), k.select()) });
            ...
            setWidth: function(a) { this.div.css("width", s(a)); return this },
            ...
            design: function(a) { if (a === o ? !this.designMode : a) { if (!this.designMode) a = this.html(), this.designMode = !0, this.html(a), this.textarea.hide(), this.iframe.show() } else if (this.designMode) a = this.html(), this.designMode = !1, this.html(a), this.iframe.hide(), this.textarea.show(); return this.focus() },
            focus: function() { this.designMode ? this.win.focus() : this.textarea[0].focus(); return this },
            blur: function() {
                if (l) {
                    var a =
        ...
        E(Aa, R, {
            init: function(a) {
                ...
                d.div.addClass("ke-toolbar").bind("contextmenu,mousedown,mousemove", function(a) { a.preventDefault() }).attr("unselectable",
                    "on");
                d.div.mouseover(function(a) { c(a, "addClass") }).mouseout(function(a) { c(a, "removeClass") }).click(function(a) {
                    var c = b(a.target);
            ...
            select: function(a) { zb.call(this, a, function(a) { a.addClass("ke-selected") }); return self },
            unselect: function(a) {
        ...
        E(ra, R, {
            ...
            remove: function() {
                m(this._cells, function() { this.unbind() });
        ...
        E(Xa, {
            ...
            submit: function() {
                ...
                b.bind("load", function() {
                    ...
                    try { g = f.json(e) } catch (h) { a.options.afterError.call(a, "<!doctype html><html>" + c.body.parentNode.innerHTML + "</html>") }
        ...
        f.uploadbutton = function(a) { return new Xa(a) };
        E(sa, R, {
            init: function(a) {
        ...
        f.ajax = function(a, b, c, d, e) {
            ...
            if (c == "POST") {
                ...
                try { g.setRequestHeader("Content-Type", "application/x-www-form-urlencoded") } catch (i) {}
                g.send(f.join("&"))
            } else g.send(null)
        };
        var V = {},
            M = {};
        ta.prototype = {
            lang: function(a) { return Gb(a, this.langType) },
            ...
            handler: function(a, b) {
                ...
                m(c._handlers[a], function() { b = this.call(c, b) });
                return b
            },
            clickToolbar: function(a, b) {
                ...
                if (b === o) {
                    ...
                    c.loadPlugin(a, function() { c.handler(d) });
                    return c
                }
            ...
            create: function() {
                ...
                var h = b.toolbar = Ab({
                    ...
                    p = b.edit = yb({
                        ...
                        cssPath: b.cssPath,
                        cssData: b.cssData,
                        beforeGetHtml: function(a) { a = b.beforeGetHtml(a); return S(a, b.filterMode ? b.htmlTags : null, b.urlType, b.wellFormatMode, b.indentChar) },
                        beforeSetHtml: function(a) { a = S(a, b.filterMode ? b.htmlTags : null, "", !1); return b.beforeSetHtml(a) },
                        ...
                        afterCreate: function() {
                            ...
                            $b.call(b);
                            ac.call(b);
                            p.afterChange(function() { p.designMode && (b.updateState(), b.addBookmark(), b.options.afterChange && b.options.afterChange.call(b)) });
                ...
                a();
                c ? (b._fullscreenResizeHandler = function() { b.isCreated && b.resize(G().clientWidth, G().clientHeight, !1) }, f(A).bind("resize", b._fullscreenResizeHandler), h.select("fullscreen"), k.first().css("visibility",
                    "hidden"), k.last().css("visibility", "hidden")) : (ea && f(A).bind("scroll", function() { b._scrollPos = ba() }), b.resizeType > 0 ? Sa({
                    moveEl: g,
                    clickEl: k,
            ...
            fullHtml: function() { return this.isCreated ? this.edit.html(o, !0) : "" },
            text: function(a) {
            ...
            selectedHtml: function() { return this.isCreated ? this.cmd.range.html() : "" },
            count: function(a) {
            ...
            sync: function() { oa(this.srcElement, this.html()); return this },
            ...
            undo: function() { return Ib.call(this, this._undoStack, this._redoStack) },
            redo: function() { return Ib.call(this, this._redoStack, this._undoStack) },
            fullscreen: function(a) { this.fullscreenMode = a === o ? !this.fullscreenMode : a; return this.remove().create() },
            readonly: function(a) {
                var a = j(a, !0),
                    b = this,
                    c = b.edit,
                ...
                b.designMode ? b.toolbar.disableAll(a, []) : m(b.noDisableItems,
                    function() { b.toolbar[a ? "disable" : "enable"](this) });
        ...
        f.sync = function(a) { Kb(a, function() { this.sync() }) };
        l && z < 7 && P(document, "BackgroundImageCache", !0);
        f.EditorClass = ta;
        f.editor = function(a) { return new ta(a) };
        f.create = Jb;
        ...
        Eb("core", function(a) {
            ...
            b.afterSetHtml(function() { b.options.afterChange && b.options.afterChange.call(b) });
                ...
                if (b.syncType == "form") {
                    ...
                    if (d) {
                        c.bind("submit", function() {
                            b.sync();
                            a(A).bind("unload", function() { b.edit.textarea.remove() })
                        });
            ...
            m("undo,redo".split(","), function(a, d) {
                c[d] && b.afterCreate(function() { Ga(this.edit.doc, c[d], function() { b.clickToolbar(d) }) });
            ...
            b.clickToolbar("formatblock", function() {
                ...
                m(a, function(a, e) {
                    ...
                    f.addItem({ title: '<span style="' + j + '" unselectable="on">' + e + "</span>", height: c[a] + 12, checked: d === a || d === e, click: function() { b.select().exec("formatblock", "<" + a + ">").hideMenu() } })
                })
            });
            ...
            m("cut,copy,paste".split(","), function(a, c) { b.clickToolbar(c, function() { b.focus(); try { b.exec(c, null) } catch (a) { alert(b.lang(c + "Error")) } }) });
            ...
            b.plugin.getSelectedImage = function() { return Ba(b.edit.cmd.range, function(a) { return !/^ke-\w+$/i.test(a[0].className) }) };
            b.plugin.getSelectedFlash = function() { return Ba(b.edit.cmd.range, function(a) { return a[0].className == "ke-flash" }) };
            b.plugin.getSelectedMedia = function() { return Ba(b.edit.cmd.range, function(a) { return a[0].className == "ke-media" || a[0].className == "ke-rm" }) };
            ...
            b.plugin.getSelectedRow =
                function() { return b.cmd.commonAncestor("tr") };
            ...
            b.afterCreate(function() {
                function c() {
                    ...
                    f.select();
                    W && (a("div." + n, j).each(function() { a(this).after("<br />").remove(!0) }), a("span.Apple-style-span", j).remove(!0), a("span.Apple-tab-span", j).remove(!0), a("span[style]", j).each(function() { a(this).css("white-space") == "nowrap" && a(this).remove(!0) }), a("meta", j).remove());
                    var d = j[0].innerHTML;
                    j.remove();
            ...
            b.beforeGetHtml(function(a) {
                l && z <= 8 && (a = a.replace(/<div\s+[^>]*data-ke-input-tag="([^"]*)"[^>]*>([\s\S]*?)<\/div>/ig, function(a, b) { return unescape(b) }), a = a.replace(/(<input)((?:\s+[^>]*)?>)/ig, function(a, b, c) { if (!/\s+type="[^"]+"/i.test(a)) return b + ' type="text"' + c; return a }));
                return a.replace(/(<(?:noscript|noscript\s[^>]*)>)([\s\S]*?)(<\/noscript>)/ig, function(a, b, c, d) { return b + fa(c).replace(/\s+/g, " ") + d }).replace(/<img[^>]*class="?ke-(flash|rm|media)"?[^>]*>/ig, function(a) {
                    var a = H(a),
                        b = aa(a.style || ""),
                        c = nb(a["data-ke-tag"]);
            ...
            b.beforeSetHtml(function(a) {
                ...
                }).replace(/<a[^>]*name="([^"]+)"[^>]*>(?:<\/a>)?/ig, function(a) { var c = H(a); if (c.href !== o) return a; return '<img class="ke-anchor" src="' + b.themesPath + 'common/anchor.gif" data-ke-name="' + escape(c.name) + '" />' }).replace(/<script([^>]*)>([\s\S]*?)<\/script>/ig, function(a, b, c) {
