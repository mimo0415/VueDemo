...
//导航
$navpath = navpath($video['cid']) . ' &raquo; <a href="read.php?vid=' . $video[vid] . '" title="' . $video[subject] . '">' . $video[subject] . '</a>';

//影片信息处理
$video['picurl'] = get_poster_url($video['picfolder'], $video['pic'], 3);
