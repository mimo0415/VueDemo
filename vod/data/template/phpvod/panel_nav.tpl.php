...
<?php } else { ?>
<?php echo $username;?>！<a href="login.php?action=quit">[退出]</a> ┆ <a href="profile.php?action=show&id=<?php echo $uid;?>">个人中心</a> ┆ <a href="message.php">短消息</a>
<?php if($user['newpm']==1) { ?><img src="<?php echo $imgpath;?>/<?php echo $stylepath;?>/new.gif" />
...
┆ <a href="arthome.php">文档</a> ┆ <a href="rss.php" target="_blank">RSS</a>