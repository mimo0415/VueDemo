...
<div class="g-main f-fl"><?php if(is_array($_artclass)) { foreach($_artclass as $classid => $classname) { ?><div class="m-box f-mb10">
<div class="title">
...
<ul class="m-artlist"><?php $articledb = pv_loop('article',"classid=$classid|limit=10|cachetime=60s"); if(is_array($articledb)) { foreach($articledb as $article) { ?><li>
